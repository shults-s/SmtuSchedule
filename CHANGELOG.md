...
## [Версия 0.9](https://github.com/shults-s/SmtuSchedule/releases/tag/0.9) от 30.10.2019
### Добавлено:
- Темная тема;
...
- Ошибка, приводившая к падению приложения из-за отсутствия необходимых runtime-разрешений на Android 6.0 и более новых версиях.