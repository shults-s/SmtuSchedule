...
## [Версия 0.8.1](https://github.com/shults-s/SmtuSchedule/releases/tag/0.8.1) от 31.08.2019
### Добавлено:
...
- Вылеты приложения на некоторых моделях смартфонов в холодном запуске, либо при возврате из фонового режима.
